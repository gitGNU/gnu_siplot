...
**
** Created: Fri Apr 29 11:48:00 2011
...
static const char qt_meta_stringdata_SettingsView[] = {
    "SettingsView\0"
};

const QMetaObject SettingsView::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_SettingsView,
      qt_meta_data_SettingsView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SettingsView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingsView))

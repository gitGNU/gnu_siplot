...
**
** Created: Fri Apr 29 11:48:09 2011
...
static const char qt_meta_stringdata_FormulaView[] = {
    "FormulaView\0"
};

const QMetaObject FormulaView::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_FormulaView,
      qt_meta_data_FormulaView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FormulaView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FormulaView))
